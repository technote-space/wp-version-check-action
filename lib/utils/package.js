...
const updatePackageVersion = (logger, context) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const results = yield constant_1.REPLACE_RULES.reduce((prev, rule) => __awaiter(void 0, void 0, void 0, function* () {
        ...
        return acc.concat(yield replace_in_file_1.replaceInFile(Object.assign(Object.assign({}, config), { files: config.file })));
    }), Promise.resolve([]));
    logger.displayStdout(misc_1.getReplaceResultMessages(results, logger));
